...
public class Link extends TableImpl<LinkRecord> {
     ...
     */
    public final TableField<LinkRecord, Integer> UPDATES_COUNT =
        createField(DSL.name("UPDATES_COUNT"), SQLDataType.INTEGER, this, "");
    ...
    public <U> SelectField<U> mapping(
        Class<U> toType,
        Function5<? super Long, ? super String, ? super OffsetDateTime, ? super OffsetDateTime, ? super Integer, ? extends U> from
    ) {
