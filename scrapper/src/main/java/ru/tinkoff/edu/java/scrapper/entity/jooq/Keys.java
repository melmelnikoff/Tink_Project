...
public class Keys {
    ...
    public static final UniqueKey<SubscriptionRecord> CONSTRAINT_9 = Internal.createUniqueKey(
        Subscription.SUBSCRIPTION,
        DSL.name("CONSTRAINT_9"),
        new TableField[] {Subscription.SUBSCRIPTION.TG_CHAT_ID, Subscription.SUBSCRIPTION.LINK_ID},
        true
    );
    ...
    public static final ForeignKey<SubscriptionRecord, TgChatRecord> CONSTRAINT_9E = Internal.createForeignKey(
        Subscription.SUBSCRIPTION,
        DSL.name("CONSTRAINT_9E"),
        new TableField[] {Subscription.SUBSCRIPTION.TG_CHAT_ID},
        Keys.CONSTRAINT_D,
